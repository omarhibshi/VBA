...
Private Sub ListBox_species_Click()
    ...
    With UserForm_DiseaseCausal
        ...
        If .OptionButton_Terre Then
            .Label17.Caption = get_top_hierarchy(Int(Tabel_species_group_Terristrial(0)(ListBox_Item_no)))
...
Function get_top_hierarchy(hierID As Integer) As String
    ...
    For i = 1 To rowCount
         If Tabel_species_hierarchy(0)(i, 1) = top_hierarchy_ID And Not IsEmpty(Tabel_species_hierarchy(3)(i, 1)) Then
            i = 1
        ...
        Else
         ...
         End If
    Next i
    get_top_hierarchy = Tabel_species_hierarchy(4)(i, 1) & " (" & _
                            Tabel_species_hierarchy(1)(i, 1) & ") = " & _
                                Tabel_species_hierarchy(2)(i, 1)
