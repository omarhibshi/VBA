...
Private Sub ListBox_Diseases_Click()
    ...
    With UserForm_DiseaseCausal
        ...
        If .OptionButton_Terre Then
            ...
            Tabel_susceptible_Species = get_Susceptible_Speciese_ids(Int(Tabel_diseases_terre(0)(ListBox_Item_no)))
        ...
        Else
            ...
            Tabel_susceptible_Species = get_Susceptible_Speciese_ids(Int(Tabel_diseases_aqua(0)(ListBox_Item_no)))
            .ListBox_species.List = Tabel_susceptible_Species(1)
        End If
    End With
End Sub
...
Private Sub ListBox_species_Click()
    ...
    With UserForm_DiseaseCausal
        ...
        If .OptionButton_Terre Then
            ...
            .ListBox_hierarchy_level.List = arr_hierarchy
        Else
        End If
...
Function get_Speciese_name(speciesID As Integer) As String
    ...
    With UserForm_DiseaseCausal
        If .OptionButton_Terre Then
            '
            Do Until Tabel_species_group_Terristrial(0)(rowCount) = speciesID Or _
                rowCount = UBound(Tabel_species_group_Terristrial(0))
                 rowCount = rowCount + 1
            Loop
            speciesName = Tabel_species_group_Terristrial(1)(rowCount)
        Else
            Do Until Tabel_species_group_Aquatic(0)(rowCount) = speciesID Or _
                rowCount = UBound(Tabel_species_group_Aquatic(0))
                 rowCount = rowCount + 1
            Loop
            speciesName = Tabel_species_group_Aquatic(1)(rowCount)
        End If
    End With
...
Function get_species_top_parent(speciesID As Integer) As Variant
    ...
    '
    For i = 1 To rowCount
         If Tabel_species_group_Terristrial(0)(i) = top_parent_ID Then
            arrSize = arrSize + 1
            ReDim Preserve arrhierarcy(arrSize)
            arrhierarcy(arrSize - 1) = Tabel_species_group_Terristrial(1)(i)
            '
            If IsEmpty(Tabel_species_group_Terristrial(2)(i)) Then
                Exit For
            Else
                top_parent_ID = Tabel_species_group_Terristrial(2)(i)
                i = 0
            End If
        End If
    Next i
    ...
    If arrSize = 0 Then
        ReDim Preserve arrhierarcy(1)
    Else
        arrhierarcy(arrSize) = get_top_hierarchy(Int(Tabel_species_group_Terristrial(3)(i)))
    End If
